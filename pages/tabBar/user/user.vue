<template>
	<view>
		...
		<view v-if="showHeader" class="header" :style="{ position: headerPosition, top: headerTop }">
			...
			<view class="icon-btn">
				<view class="icon tongzhi" @tap="user.username ? toMsg() : toLogin()"></view>
				<view class="icon setting" @tap="user.username ? toSetting() : toLogin()"></view>
			</view>
		</view>
		<!-- 占位 -->
		...
		<view class="user">
			<!-- 头像 -->
			<view class="left">
				<image :src="user.face" @tap="user.username ? toSetting() : toLogin()"></image>
			</view>
			<!-- 昵称,个性签名 -->
			<view class="right">
				<view class="username" @tap="user.username ? toSetting() : toLogin()">
					{{ user.username ? user.username : '请登录' }}
				</view>
				<view class="signature" @tap="user.username ? toSetting() : toLogin()">
					{{ user.signature }}
				</view>
			</view>
			<!-- 二维码按钮 -->
