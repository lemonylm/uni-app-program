<template>
  <view>
      ...
      <view class="swiper-box">
        ...
        >
          <swiper-item v-for="swiper in swiperList" :key="swiper.id">
            <image :src="swiper.url" @tap="toSwiper(swiper)"></image>
          </swiper-item>
        </swiper>
    ...
    <!-- 分类列表 -->
    <swiper class="categorySwiper" :indicator-dots="true">
      <swiper-item v-for="(list, index) in categoryList" :key="index">
        <view class="category-list">
          <view
            ...
            @tap="toCategory(row)"
          >
            <view class="img"><image :src="row.url"></image></view>
